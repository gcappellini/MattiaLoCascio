function [sol] = OneDimBH_no_src_poly()
  ...
  fileID = fopen('\Users\Mattia\Dropbox\Mattia\Tesi Magistrale/gt_bioheat1D_without_src_poly.csv', 'w');
  for i = 1:101
      for j = 1:101
...
colorbar;
saveas(fig, 'bioheat_1D_without_src_poly.png');
