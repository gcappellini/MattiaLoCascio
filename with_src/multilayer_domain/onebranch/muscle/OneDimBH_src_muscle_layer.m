function [sol] = OneDimBH_src_muscle_layer()
  ...
  fileID = fopen("C:\Users\Mattia\Dropbox\Mattia\Tesi Magistrale/gt_bioheat1D_src_muscle_layer.csv", 'w');
  for i = 1:101
      for j = 1:101
...
colorbar;
saveas(fig, 'bioheat_1D_src_muscle_layer.png');
...
% Save u_meas vs t
fileID_u_02 = fopen("C:\Users\Mattia\Dropbox\Mattia\Tesi Magistrale/u_meas_src_muscle_layer_02.csv", 'w');
fileID_u_05 = fopen("C:\Users\Mattia\Dropbox\Mattia\Tesi Magistrale/u_meas_src_muscle_layer_05.csv", 'w');
fileID_u_08 = fopen("C:\Users\Mattia\Dropbox\Mattia\Tesi Magistrale/u_meas_src_muscle_layer_08.csv", 'w');
  for i = 1:101
...
saveas(fig2, 'u_meas_src_muscle_layer.png');
